...
class App:
    def __init__(self, root):
        ...
        tk.Button(self.button_frame, text="Close Brower", command=self.close_brower).grid(row=0, column =1, padx=5)
    ...
    def close_brower(self):
        ...
        messagebox.showinfo("Browser Close","Submitted Successful!")
