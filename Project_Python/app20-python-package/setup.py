...
setup(
  name = 'invoicing-fdp',         #* Your package will have this name
  ...
  author = 'Long Vibol',                   # Your name
  author_email = 'vibollong@gmail.com',  # Your email
  url = 'https://example.com',              # Homepage of your library (e.g. github or your website)
  keywords = ['vibol','invoice', 'excel', 'pdf'],   # Keywords users can search on pypi.org
  ...
  classifiers=[
    ...
    'Programming Language :: Python :: 3.14','Programming Language :: Python :: 3.11',
  ],
)
